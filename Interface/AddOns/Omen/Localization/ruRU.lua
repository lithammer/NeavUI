...
L["Temp Threat Bar Color"] = "Цвет полосы температуры угрозы" -- Needs review
...
L["The background color for players under the effects of Fade, Mirror Image, glyphed Hand of Salvation, Tricks of the Trade and Misdirection"] = "Цвет фона для игроков под эффектами Уход в Тень, Зеркальное Изображение, символ Длань Спасения, Маленькие Хитрости и Перенаправление" -- Needs review
