...
local function AuraMouseover(button, ...)
    ...
    button:HookScript('OnEnter', function(self)
        ...
        button.remaining:SetFont(oUF_Neav.media.font, 13, 'THINOUTLINE')
        button.count:SetFont(oUF_Neav.media.font, 15, 'THINOUTLINE')
    end)
    
    button:HookScript('OnLeave', function(self)
        button.icon:SetSize(size, size)
        button:SetFrameLevel(1)
        button.remaining:SetFont(oUF_Neav.media.font, 8, 'THINOUTLINE')
        button.count:SetFont(oUF_Neav.media.font, 11, 'THINOUTLINE')
    end)
end
